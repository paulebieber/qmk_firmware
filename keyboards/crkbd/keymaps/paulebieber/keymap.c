...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+---,----+---.----+----_---+----ä---|
                                        KC_LGUI, TD(ALT_OSL1), KC_LSFT, KC_BSPC, KC_SPC, KC_MPLY),
                                      //`--------------------------'  `--------------------------'
...
KC_GRV, LSFT(KC_GRV), RALT(KC_8), RALT(KC_9), RALT(KC_RBRC), LSFT(KC_BSLS),       KC_0,    KC_1,     KC_2,   KC_3,   KC_DOT,   KC_NUBS, 
  //|----<---+--->----+---{----+----}---+--------+---'----+--------|  |--------+--------+--------+--------+--------+--------+---------|
                                        TO(2), KC_RALT, KC_LSFT,       KC_BSPC, KC_SPC, KC_NO),
                                      //`--------------------------'  `--------------------------'
  ...
  //|--------+--------+--------+--------+--------+--------|                    |---<----+--->----+--------+--------+--------+--------|
      TO(0), KC_F6,    KC_F7,   KC_F8,  KC_F9,   KC_F10,                         KC_NO,  KC_LEFT, KC_DOWN , KC_RIGHT, KC_NO, KC_NO,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCTL, KC_F11,  KC_F12,  KC_NO,   KC_NO,   KC_NO,                        KC_NO,   KC_NO,  RGB_SAD, RGB_SAI, RGB_HUD, RGB_HUI,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                         KC_LGUI, KC_LALT, KC_LSFT,    KC_BSPC,  KC_SPC , KC_NO),
                                      //`--------------------------'  `--------------------------'
};
